      ...
      <div className="relative bg-cover bg-center grid text-white-off" style={{ backgroundImage: `url(${tracks})` }} >
        ...
        <div className="grid lg:grid-cols-3 lg:grid-rows-2 sm:grid-cols-2 sm:grid-rows-2 gap-28 mt-24 justify-self-center w-[80vw]">
          ...
          <div className="border-solid border-2 border-[#B38FFF] grid gap-1">
            <div className="grid grid-cols-12 grid-rows-6" style={{ backgroundImage: `url(${web})` }}>
              {[...Array(72)].map((_, i) => (
                <div key={i} className="bg-[#2C1E66] border-solid border-[1px] border-[#4B28D9] text-[#2C1E66]">
                  "
                </div>
              ))}
            </div>
            <img className="justify-self-center -mt-40" src={web} alt="" width={150} />
            <div className="px-3 bg-[#724CD1] text-5xl text-center font-pixeboy">WEBSITE</div>
            ...
            <div className="px-2 py-4">
              Lorem, ipsum dolor sit amet consectetur adipisicing elit. Provident blanditiis dolorem magnam, quae reiciendis est alias placeat minima facilis maxime!
            </div>
          </div>
          <div className="border-solid border-2 border-[#B38FFF] grid gap-1">
            <div className="grid grid-cols-12 grid-rows-6" style={{ backgroundImage: `url(${web})` }}>
